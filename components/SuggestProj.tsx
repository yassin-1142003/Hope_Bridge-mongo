...
const SuggestProj = async ({ locale }: { locale: string }) => {
  ...
  const filteredProjects = details
    ?.slice(0, 3)
    ?.filter((proj: ProjectContent) => {
