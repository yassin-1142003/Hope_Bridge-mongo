    ...
    fill: isActive
      ...
      : isHighlighted
        ...
        : theme === "dark"
          ? "#9A3F3F"
          : "#9A3F3F",
    stroke: theme === "dark" ? "#9A3F3F" : "#9A3F3F",
    strokeWidth: isMobile ? 1 : 1,
    outline: "none",
    transition: isHighlighted ? "all 0.3s ease-in-out" : "none",
  },
  hover: {
    fill: isHighlighted ? "#C1856D" : theme === "dark" ? "#C1856D" : "#C1856D",
    ...
    <div className="w-full flex flex-col items-center gap-4 px-4">
      ...
      >
        ...
        <motion.div
          ...
          } relative rounded-2xl p-5 md:p-7 shadow-xl border 
       ...
       text-blue-600 dark:text-blue-300 px-3 py-1 rounded-full font-semibold shadow-sm"
          ...
          <Link href={`/${locale}/projects`}>
            ...
            >
              ...
              <ArrowRightIcon className="w-4 h-4 text-red-500 dark:text-red-400" />
            </motion.div>
          </Link>
        </motion.div>
              ...
              >
                <ComposableMap
                  ...
                  style={{
                    width: "100%",
                    height: "auto",
                    background: theme === "dark" ? "#1d1616" : "#FBF9D1",
                    borderRadius: "0px",
                  }}
                >
                  <ZoomableGroup
