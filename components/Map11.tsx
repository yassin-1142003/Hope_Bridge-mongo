  ...
  const apiProjects = [
    {
      ...
      contents: [
        {
          name: "مشروع بناء مدارس",
          description: "إنشاء مدارس مجهزة لدعم التعليم في المناطق الريفية.",
        },
      ],
    },
    {
      ...
      contents: [
        {
          name: "مشروع دعم صحي",
          description: "توفير وحدات طبية متنقلة لعلاج الأسر المحتاجة.",
        },
      ],
    },
  ];
  ...
  return (
    <div className="w-full flex flex-col items-center gap-4 px-4">
      ...
      >
            ...
            {apiProjects.map(
              (proj: {
                ...
                <Link
                  key={proj.id}
                  href={`/projects/${proj.id}`}
                  className="group flex items-center gap-4 rounded-xl border border-gray-200 
        dark:border-gray-700 p-4 w-full bg-white dark:bg-gray-900 shadow-sm 
        hover:shadow-lg hover:scale-[1.02] transition-transform duration-300"
                >
                  ...
                  <div className="flex flex-col flex-1 min-w-0">
                    <h1 className="font-bold text-base text-primary mb-1 group-hover:text-red-600 truncate">
                      {proj.contents[0]?.name}
                    </h1>
        ...
        >
          <div className="w-full flex items-center justify-center overflow-hidden rounded-2xl shadow-xl">
            {isMapVisible ? (
              <Suspense
                fallback={
                  <MapLoading
