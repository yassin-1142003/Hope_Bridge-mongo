    ...
    <div className="w-full flex flex-col items-center gap-4 px-4">
      ...
      >
        ...
        >
          ...
          {/* Title + Desc */}
          <h2 className="text-lg w-fit font-bold text-accent-foreground dark:text-gray-100 mb-2">
            ...
            {apiProjects.map(
              (proj: {
                ...
                <Link
                  key={proj.id}
                  href={`/projects/${proj.id}`}
                  className="group flex items-center gap-3 rounded-xl border border-gray-200 dark:border-gray-700 p-3 bg-white dark:bg-gray-900 shadow-sm hover:shadow-lg hover:scale-105 transition-transform duration-300"
                >
