    ...
    <div className="w-full flex flex-col items-center gap-4 px-4">
      ...
      >
        ...
        >
          ...
          {/* Related Projects */}
          <h3 className="font-semibold mt-4">بعض من مشاريعنا:</h3>
            ...
            {apiProjects.map(
              (proj: {
                ...
                <Link
                  ...
                  className="flex-1 rounded-lg border text-right border-gray-200 dark:border-gray-700 p-2 text-xs  hover:bg-gray-50 dark:hover:bg-gray-700"
                >
                  <h1 className="font-semibold line-clamp-2 text-primary">
