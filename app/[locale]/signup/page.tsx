...
function RoleSwitcher({
  ...
  const handleSwitch = (selected: "admin" | "user") => {
    setRole(selected);
    onChange(selected);
  };
  ...
  return (
    <div className="w-full flex items-center justify-center mb-6">
      <div className="relative bg-gray-100 rounded-lg p-1 w-60 h-12 flex items-center">
        {/* Active Background Slider */}
        <div
          className={`absolute top-1 bottom-1 w-1/2 bg-primary rounded-lg transition-all duration-300 ${
            role === "admin" ? "left-1" : "left-[50%]"
          }`}
        ></div>
        ...
        <button
          ...
          className={`w-1/2 z-10 text-center font-semibold transition-colors ${
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <RoleSwitcher onChange={(role) => setSelectedRole(role)} />
