            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/70">
                  {locale === 'ar' ? 'نظام إدارة المهام المستند إلى الأدوار مع التكامل مع المشاريع' : 'Role-based task management system with project integration'}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href={`/${locale}/projects`}>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 hover:bg-white/20 transition-colors text-white"
              >
