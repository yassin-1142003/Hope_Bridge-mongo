...
let EmailService = EmailService_1 = class EmailService {
    constructor(config) {
        ...
        const portStr = this.config.get("SMTP_PORT");
    ...
    async sendInternal(options) {
        ...
        const subjectWithTags = ((_a = options.tags) === null || _a === void 0 ? void 0 : _a.length)
    ...
    async sendAdminNotification(subject, body) {
        const adminEmail = this.config.get("EMAIL_FROM");
        if (!adminEmail) {
